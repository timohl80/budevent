...
export default function ShareButton({ event, className = '', compact = false }: ShareButtonProps) {
    ...
    <div className={`relative ${className}`}>
      <button
        ...
        className={`inline-flex items-center justify-center ${
          compact 
            ? 'px-2 py-1 text-xs bg-white/90 hover:bg-white text-gray-700 hover:text-[#7C3AED] rounded-full shadow-sm border border-gray-200' 
            : 'px-3 py-2 text-sm font-medium text-[#7C3AED] bg-[#7C3AED]/10 rounded-md hover:bg-[#7C3AED]/20'
        } focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7C3AED] transition-colors`}
