          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-100">Your account is pending admin approval</p>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto pt-20">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 mb-8">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700">
                  <p>Your account has been successfully created and submitted for approval. You're one step closer to joining the BudEvent community!</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>You can bookmark this page to check back later</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/auth"
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
